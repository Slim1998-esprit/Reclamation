<?php
    ...
    {  
        $listerec=$reclamation->recherchereclamation($_POST["type_reclamation"],$_POST["message"]);
...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="C:/xamppp/htdocs/Reclamation/assets/img/apple-icon.png">
    <link rel="icon" type="image/png" href="C:/xamppp/htdocs/Reclamation/assets/img/favicon.png">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    <title>Our BackOffice</title>
    ...
    <link href="C:/xamppp/htdocs/Reclamation/assets/demo/demo.css" rel="stylesheet" />
</head>
